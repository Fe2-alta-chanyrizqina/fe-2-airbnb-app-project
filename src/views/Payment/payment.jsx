...
import { Container, Navbar, Col, Row, FloatingLabel, Form, Button, Card } from "react-bootstrap"
...
const Payment = () => {
    ...
    return  <>
            ...
            <Container className="mt-5 pt-5">
                ...
                <h2 classnameName="title mt-5"> <a className="cursor-pointer" onClick={()=>goToRoom()}><MdOutlineArrowBackIos/></a> Payment & Confirm</h2>
            </Container> 
            <Container className="mt-5">
                <Row>
                    ...
                    <Col md={7} className="p-1 mb-2 form pe-5">
                        ...
                        <Row>
                            <Col md={12}>
                                <FloatingLabel controlId="floatingInput" label="Name on card"className="mb-3 mt-3">
                        ...
                        <Row>
                            <Col md={4}>
                                <Form>
                                    <Form.Group className="mt-4 ms-2 g-3" controlId="formPlaintextEmail">
                                        <Form.Label> Expired Date</Form.Label>
                                    </Form.Group>
                                </Form>
                            </Col>                                    
                            <Col md={4} sm={4} xs={4}>
                                <FloatingLabel controlId="floatingInputGrid" label="Month" className="mt-3">
                                    <Form.Control type="number" placeholder="Month" />
                                </FloatingLabel>
                            </Col>
                            <Col md={4} sm={4} xs={4}>
                                <FloatingLabel controlId="floatingSelectGrid" label="Year" className="mt-3">                                                
                                    <Form.Control type="number" placeholder="Year" />
                                </FloatingLabel>
                            </Col> 
                            <Col md={12}>
                                    <Button variant="primary"className="confirm mt-3" size="lg" width="100%">Confirm and Pay</Button>
                                    ...
                                    <Row className="g-3 mt-1">
                                        <Col md={6} sm={6} xs={6}>
                                            <FloatingLabel controlId="floatingInputGrid" label="Check-in">
                                                <Form.Control type="date" placeholder="2021-12-01" value="2021-12-12" />
                                            </FloatingLabel>
                                        </Col>
                                        <Col md={6} sm={6} xs={6}>
                                            <FloatingLabel controlId="floatingSelectGrid" label="Check-out">                                                
                                                <Form.Control type="date" placeholder="12-01-2021" value="2021-12-21" />
                                            </FloatingLabel>
                                        </Col>                                        
                                    </Row>
                                    <Row>
                                        <Col md={11} className="m-3 pr-3">
                                            <Row>
                                                ...
                                                <Col className="right-text"><b>$72</b> </Col>
                                            </Row>
                                        </Col>
                                    </Row> 
                                </Card.Text>
