...
const Login = (props) => {
  ...
  const handleLogin = (e) => {
    ...
    if ( Object.keys(newErrors).length > 0 ) {
      ...
      axios.post('http://18.188.236.245/login',objData)
      .then((response) => {
      ...
      <Modal.Body className="p-5">
        <div>
          ...
          <FloatingLabel label="Password" className="mb-3 mt-3">
              <Form.Control type="password" onChange={e => setField('password', e.target.value)} placeholder="Password" required
          ...
          <div className="divButton mt-4 d-flex justify-content-between align-items-center">
            	...
            	<Button className="col-6 btLogin" variant="primary" onClick={handleLogin}>
              	Login
            	</Button>
          </div>
        </div>
